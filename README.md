...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/bingehack/daohang)
...
- **分页功能** - 当单个分类下站点数量超过10个时，自动启用分页展示，提升用户体验
- **默认展开分类** - 支持设置特定分类（如"全球接码"、"跨境电商"）默认展开，方便用户快速访问常用内容
- **子分类独立展开** - 修复子分类展开状态管理，每个子分类独立控制展开/折叠
- **访客模式优化** - 修复访客模式下无法访问公开数据页的问题，确保公开内容可正常浏览
